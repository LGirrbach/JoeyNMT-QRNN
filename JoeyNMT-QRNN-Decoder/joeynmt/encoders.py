...
class RecurrentEncoder(Encoder):
    ...
    def __init__(self,
        ...
        if rnn_type == "qrnn":
            self.rnn = QRNN(input_size=emb_size, hidden_size=hidden_size,
                            num_layers=num_layers, batch_first=True,
                            bidirectional=bidirectional, dropout=emb_dropout,
                            **kwargs)
    ...
    def forward(self, embed_src: Tensor, src_length: Tensor, mask: Tensor) \
        ...
        #else:
            #hidden_concat = fwd_hidden_last.squeeze(0)
