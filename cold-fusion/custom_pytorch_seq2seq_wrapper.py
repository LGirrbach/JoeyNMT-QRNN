...
class CustomPytorchSeq2SeqWrapper(Seq2SeqEncoder):
    """
    ...
    def __init__(self, module: torch.nn.Module, stateful: bool = False) -> None:
        super(CustomPytorchSeq2SeqWrapper, self).__init__(stateful)
        self._module = module
        try:
    ...
    def forward(self,  # pylint: disable=arguments-differ
        ...
        return unpacked_sequence_tensor.index_select(0, restoration_indices), final_states
