...
class WeightDrop(torch.nn.Module):
    ...
    """
    def _setweights(self):
        for name_param in self.weights:
            param = self.module._parameters.get(name_param)
            param_with_droput = Parameter(torch.nn.functional.dropout(param, p=self.dropout, training=self.module.training),
    ...
    def forward(self, *args):
        self._setweights()
        return self.original_forward(*args)
